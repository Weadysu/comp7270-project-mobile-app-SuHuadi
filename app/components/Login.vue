        ...
        <FlexboxLayout>
            <StackLayout class="form">
                ...
                <StackLayout class="input-field" marginBottom="25">
                    <TextField class="input" v-model="username"
                        returnKeyType="next" hint="Username" required />
                </StackLayout>

                <StackLayout class="input-field" marginBottom="25">
                    <TextField ref="password" class="input" hint="Password"
                        secure="true" v-model="password" required />
                </StackLayout>

                <Button :text="isLoggingIn ? 'Log In' : 'Log off'"
                    @tap="submit" class="btn-primary m-t-20" />
